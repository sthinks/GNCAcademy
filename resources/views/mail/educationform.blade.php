...
<body>
<div>
<h4 style="text-align: center;" >Sayın Yetkili,</h4>
<p>Yeni bir Eğitim talep formu doldurulmuştur.Üye form bilgileri aşağıdaki gibidir.</p>
</div>
<table style="width:100%">
  <tr >
    <th colspan="2" >Kayıt Bilgileri</th>
  </tr>
  <tr  >
    <td >Ad</td>
    <td >{{$details['name']}}</td>
  ...
  <tr>
    <td>Almak İstediği Eğitimler</td>
    <td>{{$details['want_educations']}}</td>
  </tr>
  <tr>
    <td>Talep Edilen Eğitim Tarihi</td>
    <td>{{$details['education_time']}}</td>
  </tr>
  <tr>
    <td>KVKK</td>
    <td>{{$details['kvkk']}}</td>
